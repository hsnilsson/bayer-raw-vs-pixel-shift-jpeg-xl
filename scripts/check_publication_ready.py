...
REQUIRED_FILES = [
    ...
    "scripts/make_break_even_review_panels.py",
    "scripts/make_break_even_context_images.py",
    "scripts/make_break_even_review_viewers.py",
    "scripts/make_crop_selection_guides.py",
    "scripts/read_crop_selection_guides.py",
    "scripts/generate_break_even_report_site.py",
    "scripts/run_muimg_archive_qualification.py",
    "metadata/scan_annotations.json",
    "metadata/muimg_dng_jxl_probe.json",
    "metadata/muimg_lossless_qualification.json",
    "scripts/run_archival_break_even.py",
    "src/break_even_image_tools.py",
    "src/incremental_cache.py",
...
PYTHON_FILES = [
    ...
    "tests/test_muimg_archive_qualification.py",
    "tests/test_review_fixes.py",
]
