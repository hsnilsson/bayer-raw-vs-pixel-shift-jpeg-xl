...
<head>
  ...
  <style>
    ...
    * {{ box-sizing: border-box; }}
    ...
    .crop-sidebar-left {{ border-right: 1px solid #c4ccd4; }}
    .crop-sidebar-right {{ border-left: 1px solid #c4ccd4; }}
    .crop-sidebar-header {{
      position: sticky;
      top: 0;
      z-index: 1;
    ...
    .crop-sidebar-header span {{ color: #5f6b76; }}
    ...
    .crop-choice:hover, .crop-choice[aria-pressed="true"] {{ border-color: #0284c7; background: #e0f2fe; color: #0c4a6e; }}
    .crop-choice span {{ color: #5f6b76; font-size: 12px; }}
    .crop-choice[aria-pressed="true"] span {{ color: #075985; }}
    ...
    .crop-toolbar h3 {{ margin: 0 0 3px; color: #1d2329; font-size: 18px; }}
    .crop-toolbar p {{ margin: 0; color: #5f6b76; font-size: 12px; }}
    ...
    .crop-actions button[aria-pressed="true"] {{ background: #075985; border-color: #0369a1; color: #fff; }}
    #cropCanvas {{
      display: block;
      width: 100%;
      height: 100%;
    ...
    .crop-status {{ min-height: 28px; padding: 6px 14px; color: #5f6b76; background: #f7f9fa; }}
    ...
    @media (max-width: 900px) {{
      ...
      .crop-sidebar-left, .crop-sidebar-right {{ border: 0; border-bottom: 1px solid #c4ccd4; }}
      .crop-sidebar-right {{ border-top: 1px solid #c4ccd4; }}
    }}
